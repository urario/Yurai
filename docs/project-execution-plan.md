...
- 提案書の制約の正本: 新規性主張は §6.4 の1文まで / 禁止文言 §9.2("show your work"・"audit-ready"・"first/世界初"・"provenance semiring")/ 非目標 §7.2。詳細は #12 の要求仕様書([knowledge/requirements/registry.md](../knowledge/requirements/registry.md))に転記済み。
