...
* [ADR-0009: Defer multi-type targeting until a second value type is approved](ADR-0009-defer-multi-type-targeting.md) - Superseded by ADR-0018. The decimal MVP stays netstandard2.0-only while inexpensive internal boundaries preserve future options.
...
* [ADR-0016: Name the non-generic v1 carrier Traced](ADR-0016-name-the-v1-carrier-traced.md) - Superseded by ADR-0018. The decimal MVP uses a type-neutral public name without promising generic behavior.
