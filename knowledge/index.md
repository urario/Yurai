...
* [ADR-0009: Defer multi-type targeting until a second value type is approved](decisions/ADR-0009-defer-multi-type-targeting.md) - The decimal MVP stays netstandard2.0-only while preserving inexpensive future options.
