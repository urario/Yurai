...
* [ADR-0009: Defer multi-type targeting until a second value type is approved](decisions/ADR-0009-defer-multi-type-targeting.md) - Superseded by ADR-0018. The decimal MVP stays netstandard2.0-only while preserving inexpensive future options.
...
* [ADR-0016: Name the non-generic v1 carrier Traced](decisions/ADR-0016-name-the-v1-carrier-traced.md) - Superseded by ADR-0018. The decimal MVP uses a type-neutral public name without generic promises.
